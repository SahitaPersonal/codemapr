  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-2 flex flex-col gap-1">
      ...
      <div className="flex flex-col gap-1">
        {onToggleLabels && (
          <button
            ...
            style={{ color: showLabels ? '#2563eb' : '#374151' }}
          >
        ...
        {onToggleMiniMap && (
          <button
            ...
            style={{ color: showMiniMap ? '#2563eb' : '#374151' }}
          >
            <Settings size={16} />
          </button>
        )}
      ...
      <div className="relative group">
        ...
        {/* Export Dropdown */}
        <div className="absolute right-full top-0 mr-2 bg-white rounded-lg shadow-xl border border-gray-200 p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
